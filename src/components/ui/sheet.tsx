  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed z-50 flex h-full w-72 flex-col bg-sidebar p-4 shadow-panel",
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-3 right-3 grid size-10 place-items-center rounded-sm text-muted hover:bg-surface-2 hover:text-fg">
          <X className="size-4" />
