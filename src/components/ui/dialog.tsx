    ...
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          "rounded-2xl bg-surface p-5 shadow-panel",
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 grid size-9 place-items-center rounded-sm text-muted hover:bg-surface-2 hover:text-fg">
          <X className="size-4" />
